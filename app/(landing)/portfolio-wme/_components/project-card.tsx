...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  // Si des labels actifs sont définis et que ce projet n'a aucun label actif, on le cache
  if (activeLabels.length > 0 && !labels.some((label) => activeLabels.includes(label))) {
    return null
  }
