...
export const projectsData = [
  ...
  },
  {
    ...
    tags: ["Manufacturing", "Time tracking"],
    section: "Others",
  },
  {
    id: 11,
  ...
  },
  {
    ...
    description:
      "Successfully integrated the I AM Meter platform with Monday.com, enabling both daily and monthly synchronization of electricity usage for all units. This ensures more accurate reporting and automates electricity bill generation and delivery to tenants.",
