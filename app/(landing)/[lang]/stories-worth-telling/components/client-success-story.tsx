      ...
      <div className={`${backgroundColor} py-8 px-6 md:px-8 lg:px-10 flex-1 flex flex-col justify-center`}>
        <Card className={`border-0 shadow-none ${backgroundColor} ${textColor}`}>
          <div className="flex justify-center">
            <Badge className="text-sm px-3 py-1 bg-primary/20 text-primary-foreground">
              {dictionary.successStory}
            </Badge>
          </div>
          ...
          <CardContent className="space-y-4 text-center">
            ...
            <p className="text-base">
              <span className="text-blue-400 font-medium">{dictionary.wmeSolutions}</span> {dictionary.similarEfficiency}
            </p>
          </CardContent>
          <CardFooter className="flex flex-col items-center space-y-4 pt-2">
            <Link href="/contact-us">
              <Button className="rounded-full px-6 text-black" variant="outline">
                {dictionary.contactUs} <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
          </CardFooter>
        </Card>
